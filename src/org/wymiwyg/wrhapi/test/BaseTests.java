...
public class BaseTests extends TestCase {
    ...
    private void testSimpleBody(final boolean writeBody)
        throws Exception {
    ...
    public void testMultipleRequestHeader() throws Exception {
        ...
        WebServer webServer = createServer().startNewWebServer(new Handler() {
                    public void handle(Request request, Response response)
                        ...
                        response.setHeader(HeaderName.COOKIE,
                            receivedHeaderValue);
    ...
    public void testStatusCode() throws Exception {
        ...
        WebServer webServer = createServer().startNewWebServer(new Handler() {
                    public void handle(Request request, Response response)
                        ...
                        response.setResponseStatus(ResponseStatus.getInstanceByCode(
                                statusCode));
                        response.setHeader(HeaderName.SERVER,
                            "Ad-Hoc testing server");
                    }
                }, serverBinding);
